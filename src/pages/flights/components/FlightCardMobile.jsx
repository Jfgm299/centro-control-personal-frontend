      ...
      <div className="text-right shrink-0 flex flex-col items-end gap-1">
        ...
        <div className="flex gap-1 mt-1">
          <button
            ...
            className="w-7 h-7 flex items-center justify-center rounded-lg text-white/50 hover:text-white hover:bg-white/10 transition-all active:scale-90"
          >
          ...
          {confirmDelete ? (
            <div className="flex gap-1">
              <button onClick={() => deleteFlight.mutate(flight.id)} className="text-xs px-2 py-1 bg-red-500/40 text-white rounded-lg border border-red-500/50 transition-all active:scale-95">✓</button>
              <button onClick={() => setConfirmDelete(false)} className="text-xs px-2 py-1 border border-white/20 text-white/70 rounded-lg transition-all active:scale-95">✕</button>
            </div>
          ) : (
            <button
              onClick={() => setConfirmDelete(true)}
              className="w-7 h-7 flex items-center justify-center rounded-lg text-white/50 hover:text-red-400 hover:bg-red-400/10 transition-all active:scale-90"
            >
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
