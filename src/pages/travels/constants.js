...
export const ACTIVITY_CATEGORY_MAP = Object.fromEntries(
...
export const MAX_PHOTOS_PER_TRIP = 30

// ISO2 → numeric ID in world-atlas TopoJSON (countries-110m)
// Used to highlight visited countries on the map
export const ISO2_TO_NUMERIC = {
  AF:'004',AX:'008',AL:'008',DZ:'012',AS:'016',AD:'020',AO:'024',AI:'660',
  ...
  SS:'728',ES:'724',LK:'144',SD:'736',SR:'740',SJ:'744',SE:'752',CH:'756',
