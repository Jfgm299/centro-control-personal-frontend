      ...
      <div className="flex flex-col gap-0.5 px-1">
        {categories.map(cat => {
          ...
          return (
            ...
            >
              <div className="w-2 h-2 rounded-full shrink-0 shadow-sm" style={{ background: cat.color ?? '#9ca3af' }} />
              <span className={clsx(
              ...
              >
                {visible ? (<svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
